...
<body>
	...
	<a name="getImg" id="getImg" class="btn btn-sucesss" href="#"
		role="button" onclick="getImg();">获取</a>
		...
		$(function() {
			...
			weui.uploader('#uploader', {
				...
				onBeforeSend : function(data, headers) {
					...
					$.extend(data, {
						// 在这里可以自定义请求参数，如此服务器端的action需要使用一个同名（fileName）字段来接受请求这个请求参数数据
						fileName : fileName,
					});
				// return false; // 阻止文件上传
				},
